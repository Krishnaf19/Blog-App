  ...
  return (
    <Link to={`/post/${$id}`}>
      <div className="w-full rounded-xl overflow-hidden border border-white/5 bg-white/2 shadow-2xs hover:shadow-md transition-all duration-300 group glass-card">
        <div className="w-full overflow-hidden bg-gray-100 h-70 relative">
          <img
        ...
        <div className="p-6">
          ...
          <p className="text-sm text-gray-600 group-hover:text-gray-500 transition-colors">Read article →</p>
        </div>
      </div>
    </Link>
  )
